...
class AddProjectJWKS extends \Vendor\Library\Generated\Runtime\Client\BaseEndpoint implements \Vendor\Library\Generated\Runtime\Client\Endpoint
{
    ...
    */
    public function __construct(string $projectId, \Vendor\Library\Generated\Model\AddProjectJWKSRequest $requestBody)
    {
    ...
    {
        if ($this->body instanceof \Vendor\Library\Generated\Model\AddProjectJWKSRequest) {
     ...
     *
     *
     * @return null|\Vendor\Library\Generated\Model\JWKSCreationOperation|\Vendor\Library\Generated\Model\GeneralError
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (201 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'Vendor\Library\Generated\Model\JWKSCreationOperation', 'json');
        }
