...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ResponseCreatedProjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Vendor\Library\Generated\Model\ResponseCreatedProject::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Vendor\Library\Generated\Model\ResponseCreatedProject::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Vendor\Library\Generated\Model\ResponseCreatedProject();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('project', $data)) {
                $object->setProject($this->denormalizer->denormalize($data['project'], \Vendor\Library\Generated\Model\Project::class, 'json', $context));
                unset($data['project']);
            }
            if (\array_key_exists('connection_uris', $data)) {
                $values = [];
                foreach ($data['connection_uris'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Vendor\Library\Generated\Model\ConnectionDetails::class, 'json', $context);
                }
            ...
            if (\array_key_exists('roles', $data)) {
                ...
                foreach ($data['roles'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \Vendor\Library\Generated\Model\Role::class, 'json', $context);
                }
            ...
            if (\array_key_exists('databases', $data)) {
                ...
                foreach ($data['databases'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, \Vendor\Library\Generated\Model\Database::class, 'json', $context);
                }
            ...
            if (\array_key_exists('operations', $data)) {
                ...
                foreach ($data['operations'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, \Vendor\Library\Generated\Model\Operation::class, 'json', $context);
                }
            ...
            if (\array_key_exists('endpoints', $data)) {
                ...
                foreach ($data['endpoints'] as $value_4) {
                    $values_4[] = $this->denormalizer->denormalize($value_4, \Vendor\Library\Generated\Model\Endpoint::class, 'json', $context);
                }
        ...
        {
            return [\Vendor\Library\Generated\Model\ResponseCreatedProject::class => false];
        }
    }
} else {
    class ResponseCreatedProjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
