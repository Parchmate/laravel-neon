...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class CurrentUserInfoAuthResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Vendor\Library\Generated\Model\CurrentUserInfoAuthResponse::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Vendor\Library\Generated\Model\CurrentUserInfoAuthResponse::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Vendor\Library\Generated\Model\CurrentUserInfoAuthResponse();
            ...
            if (\array_key_exists('linked_accounts', $data)) {
                ...
                foreach ($data['linked_accounts'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \Vendor\Library\Generated\Model\LinkedAuthAccount::class, 'json', $context);
                }
        ...
        {
            return [\Vendor\Library\Generated\Model\CurrentUserInfoAuthResponse::class => false];
        }
    }
} else {
    class CurrentUserInfoAuthResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
