...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ProjectSettingsDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Vendor\Library\Generated\Model\ProjectSettingsData::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Vendor\Library\Generated\Model\ProjectSettingsData::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Vendor\Library\Generated\Model\ProjectSettingsData();
            if (null === $data || false === \is_array($data)) {
                return $object;
            }
            if (\array_key_exists('quota', $data)) {
                $object->setQuota($this->denormalizer->denormalize($data['quota'], \Vendor\Library\Generated\Model\ProjectQuota::class, 'json', $context));
                unset($data['quota']);
            }
            if (\array_key_exists('allowed_ips', $data)) {
                $object->setAllowedIps($this->denormalizer->denormalize($data['allowed_ips'], \Vendor\Library\Generated\Model\AllowedIps::class, 'json', $context));
            ...
            if (\array_key_exists('maintenance_window', $data)) {
                $object->setMaintenanceWindow($this->denormalizer->denormalize($data['maintenance_window'], \Vendor\Library\Generated\Model\MaintenanceWindow::class, 'json', $context));
            ...
            if (\array_key_exists('preload_libraries', $data)) {
                $object->setPreloadLibraries($this->denormalizer->denormalize($data['preload_libraries'], \Vendor\Library\Generated\Model\PreloadLibraries::class, 'json', $context));
        ...
        {
            return [\Vendor\Library\Generated\Model\ProjectSettingsData::class => false];
        }
    }
} else {
    class ProjectSettingsDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
