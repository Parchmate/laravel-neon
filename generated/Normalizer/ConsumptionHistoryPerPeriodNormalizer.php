...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ConsumptionHistoryPerPeriodNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Vendor\Library\Generated\Model\ConsumptionHistoryPerPeriod::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Vendor\Library\Generated\Model\ConsumptionHistoryPerPeriod::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Vendor\Library\Generated\Model\ConsumptionHistoryPerPeriod();
            ...
            if (\array_key_exists('consumption', $data)) {
                ...
                foreach ($data['consumption'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Vendor\Library\Generated\Model\ConsumptionHistoryPerTimeframe::class, 'json', $context);
                }
        ...
        {
            return [\Vendor\Library\Generated\Model\ConsumptionHistoryPerPeriod::class => false];
        }
    }
} else {
    class ConsumptionHistoryPerPeriodNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
