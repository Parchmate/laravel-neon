...
class GetConsumptionHistoryPerProjectForbiddenException extends ForbiddenException
{
    /**
    ...
    {
        parent::__construct('This endpoint is not available. It is only supported with Scale, Business, and Enterprise plan accounts.');
