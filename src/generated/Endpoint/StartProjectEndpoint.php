...
class StartProjectEndpoint extends \Parchmate\LaravelNeon\Generated\Runtime\Client\BaseEndpoint implements \Parchmate\LaravelNeon\Generated\Runtime\Client\Endpoint
{
    ...
    */
    ...
    {
        return str_replace(['{project_id}', '{endpoint_id}'], [$this->project_id, $this->endpoint_id], '/projects/{project_id}/endpoints/{endpoint_id}/start');
    }
