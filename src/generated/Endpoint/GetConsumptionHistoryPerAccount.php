...
class GetConsumptionHistoryPerAccount extends \Parchmate\LaravelNeon\Generated\Runtime\Client\BaseEndpoint implements \Parchmate\LaravelNeon\Generated\Runtime\Client\Endpoint
{
    /**
    ...
    */
     ...
     *
     * @return null|\Parchmate\LaravelNeon\Generated\Model\ConsumptionHistoryPerAccountResponse|\Parchmate\LaravelNeon\Generated\Model\GeneralError
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (200 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'Parchmate\LaravelNeon\Generated\Model\ConsumptionHistoryPerAccountResponse', 'json');
        }
        if (is_null($contentType) === false && (403 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            throw new \Parchmate\LaravelNeon\Generated\Exception\GetConsumptionHistoryPerAccountForbiddenException($serializer->deserialize($body, 'Parchmate\LaravelNeon\Generated\Model\GeneralError', 'json'), $response);
        }
        if (is_null($contentType) === false && (404 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            throw new \Parchmate\LaravelNeon\Generated\Exception\GetConsumptionHistoryPerAccountNotFoundException($serializer->deserialize($body, 'Parchmate\LaravelNeon\Generated\Model\GeneralError', 'json'), $response);
        }
        if (is_null($contentType) === false && (406 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            throw new \Parchmate\LaravelNeon\Generated\Exception\GetConsumptionHistoryPerAccountNotAcceptableException($serializer->deserialize($body, 'Parchmate\LaravelNeon\Generated\Model\GeneralError', 'json'), $response);
        }
        if (is_null($contentType) === false && (429 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            throw new \Parchmate\LaravelNeon\Generated\Exception\GetConsumptionHistoryPerAccountTooManyRequestsException($serializer->deserialize($body, 'Parchmate\LaravelNeon\Generated\Model\GeneralError', 'json'), $response);
        }
