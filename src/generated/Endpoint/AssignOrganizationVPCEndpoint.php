...
class AssignOrganizationVPCEndpoint extends \Parchmate\LaravelNeon\Generated\Runtime\Client\BaseEndpoint implements \Parchmate\LaravelNeon\Generated\Runtime\Client\Endpoint
{
    protected $org_id;
    protected $region_id;
    ...
    */
    public function __construct(string $orgId, string $regionId, string $vpcEndpointId, \Parchmate\LaravelNeon\Generated\Model\VPCEndpointAssignment $requestBody)
    {
        $this->org_id = $orgId;
