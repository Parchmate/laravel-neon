...
class CreateProjectBranch extends \Parchmate\LaravelNeon\Generated\Runtime\Client\BaseEndpoint implements \Parchmate\LaravelNeon\Generated\Runtime\Client\Endpoint
{
    ...
    */
    public function __construct(string $projectId, ?\Parchmate\LaravelNeon\Generated\Model\ProjectsProjectIdBranchesPostBody $requestBody = null)
    {
    ...
    {
        if ($this->body instanceof \Parchmate\LaravelNeon\Generated\Model\ProjectsProjectIdBranchesPostBody) {
     ...
     *
     *
     * @return null|\Parchmate\LaravelNeon\Generated\Model\ResponseCreatedBranch|\Parchmate\LaravelNeon\Generated\Model\GeneralError
     */
    protected function transformResponseBody(\Psr\Http\Message\ResponseInterface $response, \Symfony\Component\Serializer\SerializerInterface $serializer, ?string $contentType = null)
    {
        ...
        if (is_null($contentType) === false && (201 === $status && mb_strpos($contentType, 'application/json') !== false)) {
            return $serializer->deserialize($body, 'Parchmate\LaravelNeon\Generated\Model\ResponseCreatedBranch', 'json');
        }
