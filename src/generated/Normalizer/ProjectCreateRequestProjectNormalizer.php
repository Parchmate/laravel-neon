...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ProjectCreateRequestProjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Parchmate\LaravelNeon\Generated\Model\ProjectCreateRequestProject::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Parchmate\LaravelNeon\Generated\Model\ProjectCreateRequestProject::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Parchmate\LaravelNeon\Generated\Model\ProjectCreateRequestProject();
            ...
            if (\array_key_exists('settings', $data)) {
                $object->setSettings($this->denormalizer->denormalize($data['settings'], \Parchmate\LaravelNeon\Generated\Model\ProjectSettingsData::class, 'json', $context));
                unset($data['settings']);
            }
            ...
            if (\array_key_exists('branch', $data)) {
                $object->setBranch($this->denormalizer->denormalize($data['branch'], \Parchmate\LaravelNeon\Generated\Model\ProjectCreateRequestProjectBranch::class, 'json', $context));
                unset($data['branch']);
            }
            ...
            if (\array_key_exists('default_endpoint_settings', $data)) {
                $object->setDefaultEndpointSettings($this->denormalizer->denormalize($data['default_endpoint_settings'], \Parchmate\LaravelNeon\Generated\Model\DefaultEndpointSettings::class, 'json', $context));
        ...
        {
            return [\Parchmate\LaravelNeon\Generated\Model\ProjectCreateRequestProject::class => false];
        }
    }
} else {
    class ProjectCreateRequestProjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
