...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class BillingAccountNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Parchmate\LaravelNeon\Generated\Model\BillingAccount::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Parchmate\LaravelNeon\Generated\Model\BillingAccount::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Parchmate\LaravelNeon\Generated\Model\BillingAccount();
            ...
            if (\array_key_exists('payment_source', $data)) {
                $object->setPaymentSource($this->denormalizer->denormalize($data['payment_source'], \Parchmate\LaravelNeon\Generated\Model\PaymentSource::class, 'json', $context));
        ...
        {
            return [\Parchmate\LaravelNeon\Generated\Model\BillingAccount::class => false];
        }
    }
} else {
    class BillingAccountNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
