...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ResponseCreatedBranchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Parchmate\LaravelNeon\Generated\Model\ResponseCreatedBranch::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Parchmate\LaravelNeon\Generated\Model\ResponseCreatedBranch::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Parchmate\LaravelNeon\Generated\Model\ResponseCreatedBranch();
            ...
            if (\array_key_exists('endpoints', $data)) {
                ...
                foreach ($data['endpoints'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Parchmate\LaravelNeon\Generated\Model\Endpoint::class, 'json', $context);
                }
            ...
            if (\array_key_exists('operations', $data)) {
                ...
                foreach ($data['operations'] as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, \Parchmate\LaravelNeon\Generated\Model\Operation::class, 'json', $context);
                }
            ...
            if (\array_key_exists('roles', $data)) {
                ...
                foreach ($data['roles'] as $value_2) {
                    $values_2[] = $this->denormalizer->denormalize($value_2, \Parchmate\LaravelNeon\Generated\Model\Role::class, 'json', $context);
                }
            ...
            if (\array_key_exists('databases', $data)) {
                ...
                foreach ($data['databases'] as $value_3) {
                    $values_3[] = $this->denormalizer->denormalize($value_3, \Parchmate\LaravelNeon\Generated\Model\Database::class, 'json', $context);
                }
            ...
            if (\array_key_exists('connection_uris', $data)) {
                ...
                foreach ($data['connection_uris'] as $value_4) {
                    $values_4[] = $this->denormalizer->denormalize($value_4, \Parchmate\LaravelNeon\Generated\Model\ConnectionDetails::class, 'json', $context);
                }
        ...
        {
            return [\Parchmate\LaravelNeon\Generated\Model\ResponseCreatedBranch::class => false];
        }
    }
} else {
    class ResponseCreatedBranchNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
