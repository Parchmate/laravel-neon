...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class ProjectsSharedGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Parchmate\LaravelNeon\Generated\Model\ProjectsSharedGetResponse200::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Parchmate\LaravelNeon\Generated\Model\ProjectsSharedGetResponse200::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Parchmate\LaravelNeon\Generated\Model\ProjectsSharedGetResponse200();
            ...
            if (\array_key_exists('projects', $data)) {
                ...
                foreach ($data['projects'] as $value) {
                    $values[] = $this->denormalizer->denormalize($value, \Parchmate\LaravelNeon\Generated\Model\ProjectListItem::class, 'json', $context);
                }
        ...
        {
            return [\Parchmate\LaravelNeon\Generated\Model\ProjectsSharedGetResponse200::class => false];
        }
    }
} else {
    class ProjectsSharedGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
