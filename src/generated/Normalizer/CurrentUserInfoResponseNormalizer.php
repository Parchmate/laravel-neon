...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class CurrentUserInfoResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return $type === \Parchmate\LaravelNeon\Generated\Model\CurrentUserInfoResponse::class;
        }
        public function supportsNormalization(mixed $data, string $format = null, array $context = []): bool
        {
            return is_object($data) && get_class($data) === \Parchmate\LaravelNeon\Generated\Model\CurrentUserInfoResponse::class;
        }
        public function denormalize(mixed $data, string $type, string $format = null, array $context = []): mixed
        {
            ...
            $object = new \Parchmate\LaravelNeon\Generated\Model\CurrentUserInfoResponse();
            ...
            if (\array_key_exists('billing_account', $data)) {
                $object->setBillingAccount($this->denormalizer->denormalize($data['billing_account'], \Parchmate\LaravelNeon\Generated\Model\BillingAccount::class, 'json', $context));
        ...
        {
            return [\Parchmate\LaravelNeon\Generated\Model\CurrentUserInfoResponse::class => false];
        }
    }
} else {
    class CurrentUserInfoResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
